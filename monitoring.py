...
# Remove duplicate psutil import

from pydantic import BaseModel, Field

try:
    from error_handling import ErrorSeverity, FeedXMLError
except ImportError:
...
class MetricsCollector:
    ...
    def get_system_metrics(self) -> PerformanceMetrics:
        ...
        # Use cache if recent
        if self.system_metrics_cache and current_time - self.last_system_check < self.cache_ttl:
        ...
        try:
            ...
            return PerformanceMetrics(
                cpu_percent=0, memory_percent=0, memory_used_mb=0, memory_available_mb=0, disk_usage_percent=0
            )
...
class AlertManager:
    ...
    def create_alert(self, name: str, message: str, severity: AlertSeverity, context: Dict[str, Any]):
        ...
        for alert in self.alerts[-10:]:  # Check last 10 alerts
            if alert.name == name and not alert.resolved and time.time() - alert.timestamp < 300:  # 5 minutes
    ...
    async def track_operation(self, operation_name: str, tags: Optional[Dict[str, str]] = None):
        ...
        try:
            ...
            structlog.get_logger().error(
                "Operation failed", operation=operation_name, duration=duration, error=str(e), tags=tags
            )
            raise
    ...
    async def run_health_checks(self) -> Dict[str, Any]:
        ...
        for name, check_func in self.health_checks.items():
            try:
                ...
                results[name] = {"healthy": healthy, "duration": duration, "timestamp": time.time()}
...
class MonitoringManager:
    ...
    def get_dashboard_data(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "health_checks": asyncio.create_task(self.health.run_health_checks())
