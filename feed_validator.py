...
class FeedValidator:
    ...
    def __init__(self):
        ...
        # Recommended fields
        self.google_recommended = ["gtin", "mpn", "google_product_category", "custom_label_0"]

        self.facebook_recommended = ["gtin", "mpn", "quantity", "sale_price"]

    def add_issue(self, severity: str, field: str, message: str, product_id: str = None, platform: str = None):
        """Add a validation issue"""
        issue = ValidationIssue(
            severity=severity, field=field, message=message, product_id=product_id, platform=platform
        )
    ...
    def validate_availability(self, availability: str) -> bool:
        ...
        valid_values = ["in stock", "out of stock", "preorder", "available for order", "discontinued", "pending"]
